...
// Background images mapped to different pages/routes
const pageBackgrounds: Record<string, string> = {
  "/": "https://ik.imagekit.io/h7rza8886p/style-is-candid-image-photography-with-natural__16995.jpeg?updatedAt=1754994826039",
  "/about":
    "https://ik.imagekit.io/h7rza8886p/united-states-capitol-building-at-sunset-washing-2025-03-24-12-36-35-utc.jpg?updatedAt=1754465975443",
  "/contact":
    "https://ik.imagekit.io/h7rza8886p/boston-street-buildings-at-sunset-boston-massac-2025-04-01-23-26-26-utc.jpg?updatedAt=1754465975586",
  "/write-for-us":
    "https://ik.imagekit.io/h7rza8886p/national-gallery-of-art-west-building-at-sunset-2025-03-26-21-19-18-utc.jpg?updatedAt=1754465975552",
  "/attractions":
    "https://ik.imagekit.io/h7rza8886p/united-states-capitol-building-at-sunset-washing-2025-03-24-12-36-35-utc.jpg?updatedAt=1754465975443",
  "/entertainment":
    "https://ik.imagekit.io/h7rza8886p/boston-street-buildings-at-sunset-boston-massac-2025-04-01-23-26-26-utc.jpg?updatedAt=1754465975586",
...
export default function Hero({ title, subtitle, ctaText, ctaLink }: HeroProps) {
  ...
  // Get the background image for current page
  const getCurrentBackgroundImage = () => {
    return pageBackgrounds[pathname] || pageBackgrounds["default"];
  };
  ...
  return (
    <div className="relative h-[80vh] max-h-[800px] min-h-[600px] flex items-center justify-center ">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* Fixed background image based on current page */}
        <div
              ...
              <input
                ...
                placeholder={
                  mounted && window.innerWidth >= 768
                    ? "Where to explore in Washington, DC?"
                    : "Explore in Washington?"
                }
