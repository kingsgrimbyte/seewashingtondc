...
export const metadata: Metadata = {
  title: 'Washington, DC Attractions | Best Activities & Experiences',
  description: 'Discover Washington, DC’s best attractions, museums, monuments, tours, and local events. Plan your trip with top activities and unforgettable experiences.',
   alternates: {
