...
export const metadata: Metadata = {
  title:
    "Things to Do in Washington, DC | Best Washington, DC Attractions & Activities",
  description:
    "Discover the best things to do in Washington, DC, including top attractions, museums, outdoor activities, and local events. Plan your perfect trip to Washington, DC today!",
  openGraph: {
    title:
      "Things to Do in Washington, DC | Best Washington, DC Attractions & Activities",
    description:
    ...
    <main className="min-h-screen">
            ...
            >
              <div className="bg-white rounded-2xl shadow-sm hover:shadow-md p-4 flex flex-col items-center justify-center w-28 h-28 border border-gray-100 backdrop-blur-sm hover:bg-primary/5">
                <span className="text-3xl mb-2">
                  <AppIcon name={category.icon as any} className="text-3xl" />
                </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10">
              <span
                className={`px-4 py-1 bg-gradient-to-r ${whyVisitDC.badgeColor} ${whyVisitDC.badgeTextColor} rounded-full text-xs font-medium mb-6 inline-block shadow-sm`}
              >
                {whyVisitDC.badge}
              </span>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 leading-tight">
                ...
                <span
                  className={`bg-clip-text text-transparent bg-primary ${whyVisitDC.titleGradient}`}
                >
                  {" "}
                  Must-Visit City
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Washington, DC is home to iconic landmarks and world-class
                  museums, offering visitors a unique cultural and historical
                  experience.
                </p>
              </div>
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  DC's Smithsonian Museums provide free access to some of the
                  most renowned collections of art, history, and science.
                </p>
              </div>
              <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary to-secondary opacity-10 rounded-bl-full group-hover:opacity-20 transition-opacity duration-500"></div>
            </div>
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  The city boasts a wide range of dining options, from upscale
                  restaurants to trendy food markets, offering something for
                  every taste.
                </p>
              </div>
              <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary to-secondary opacity-10 rounded-bl-full group-hover:opacity-20 transition-opacity duration-500"></div>
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  DC's nightlife is buzzing with vibrant bars, lounges, and live
                  music venues, ensuring something for everyone after dark.
                </p>
              </div>
              <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary to-secondary opacity-10 rounded-bl-full group-hover:opacity-20 transition-opacity duration-500"></div>
            </div>
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Whether it's kayaking on the Potomac or hiking in Rock Creek
                  Park, DC offers plenty of outdoor adventures for nature lovers
            ...
            <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed">
                  With an efficient Metro system, DC Circulator, and easy access
                  to major airports, getting around the city is hassle-free.
                </p>
              </div>
              <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary to-secondary opacity-10 rounded-bl-full group-hover:opacity-20 transition-opacity duration-500"></div>
            </div>
      ...
      <section className="py-10 px-4 md:px-8 max-w-7xl mx-auto relative overflow-hidden ">
        ...
        <div className="mb-8 relative">
          ...
          <h2 className="text-3xl font-bold mb-2 bg-clip-text text-transparent bg-primary ">
            What's Popular Right Now in Washington, DC
          </h2>
          <p className="text-lg text-gray-600 md:w-2/3">
            Washington, DC is always buzzing with exciting events, festivals,
            and activities. Depending on the time of year, you can experience
            the energy of local celebrations, art exhibitions, or outdoor
            adventures. From seasonal showcases to neighborhood happenings,
            there's always something new to discover—whether you're planning
            ahead or exploring on the fly.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Easily find attractions, restaurants, museums, and more based on
              your location or areas of interest.
            </p>
